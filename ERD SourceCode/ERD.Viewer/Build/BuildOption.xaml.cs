...
namespace ERD.Viewer.Build
{
  ...
  public partial class BuildOption : UserControlBase
  {
    ...
    public BuildOption(ErdCanvasModel sampleCanvas)
    {
      ...
      try
      {
        switch (this.OptionSetup.RepeatOption)
        {
          case RepeatOptionEnum.ForeachCanvas:
            ...
            this.uxSampleScript.Text = this.scripting.BuildSampleForeachCanvasScript(this.canvas, this.OptionSetup);

            break;

          case RepeatOptionEnum.ForeachTableProject:

            this.uxSampleScript.Text = this.scripting.BuildSampleForeachTableScript(this.canvas, this.canvas.SegmentTables[0], this.OptionSetup);
